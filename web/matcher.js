...
async function getConnections() {
    ...
    try {
        ...
        const fullPrompt = `${formattedSupabaseData}\n\nUser query: "${userPrompt}"\n\nBased on the available items and my query, identify any items that match my intent or provide relevant information. Be concise and helpful. Only state Potential Match Found! - new line x2, Name: (name) new line x2, University: (full university name) new line x2, Relevant Interests: (list all tags hyphon bullet pointed), new line x2, LinkedIn: (hyperlink the linkedin)`;
